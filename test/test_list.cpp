...
{
  l.InserToHead(5);
  EXPECT_EQ(5, l.GetHead()->GetDat());
  EXPECT_EQ(NULL, l.GetHead()->GetNextNode());
}
...
{
  List l2;
  ASSERT_NO_THROW(l.Merge(l.GetHead(), l2)); // ? тут неоднозначно. људем считать, что исключени§ нет, список не мен§етс§
}
...
{
  EXPECT_EQ(1, l.GetHead()->GetDat());
  EXPECT_EQ(2, l.GetHead()->GetNextNode()->GetDat());
  EXPECT_EQ(3, l.GetHead()->GetNextNode()->GetNextNode()->GetDat());
  EXPECT_EQ(NULL, l.GetHead()->GetNextNode()->GetNextNode()->GetNextNode());
}
...
TEST_F(ThreeNodesList, copy_of_not_empty_list_is_correct)
{
  ...
  EXPECT_EQ(1, l2.GetHead()->GetDat());
  EXPECT_EQ(2, l2.GetHead()->GetNextNode()->GetDat());
  EXPECT_EQ(3, l2.GetHead()->GetNextNode()->GetNextNode()->GetDat());
  EXPECT_EQ(NULL, l2.GetHead()->GetNextNode()->GetNextNode()->GetNextNode());
}
...
TEST_F(ThreeNodesList, copied_list_has_its_own_memory)
{
  ...
  EXPECT_NE(l.GetHead()->GetNextNode(), l2.GetHead()->GetNextNode());
  EXPECT_NE(l.GetHead()->GetNextNode()->GetNextNode(), l2.GetHead()->GetNextNode()->GetNextNode());
}
...
TEST_F(ThreeNodesList, can_insert_to_head_for_not_empty_list)
{
  l.InserToHead(5);
  EXPECT_EQ(5, l.GetHead()->GetDat());
  EXPECT_EQ(1, l.GetHead()->GetNextNode()->GetDat());
}

TEST_F(ThreeNodesList, can_insert_to_tail_for_not_empty_list)
{
  l.InserToTail(5);
  EXPECT_EQ(5, l.GetHead()->GetNextNode()->GetNextNode()->GetNextNode()->GetDat());
  EXPECT_EQ(NULL, l.GetHead()->GetNextNode()->GetNextNode()->GetNextNode()->GetNextNode());
}
...
TEST_F(ThreeNodesList, insert_after_ptr_for_not_empty_list_is_correct)
{
  ...
  EXPECT_EQ(2, l.GetHead()->GetNextNode()->GetDat());
  EXPECT_EQ(5, l.GetHead()->GetNextNode()->GetNextNode()->GetDat());
  EXPECT_EQ(3, l.GetHead()->GetNextNode()->GetNextNode()->GetNextNode()->GetDat());
  EXPECT_EQ(NULL, l.GetHead()->GetNextNode()->GetNextNode()->GetNextNode()->GetNextNode());
}
...
TEST_F(ThreeNodesList, can_delete_middle_from_not_empty_list)
{
  l.Delete(2);
  EXPECT_EQ(1, l.GetHead()->GetDat());
  EXPECT_EQ(3, l.GetHead()->GetNextNode()->GetDat());
}
...
TEST_F(ThreeNodesList, can_delete_tail_from_not_empty_list)
{
  ...
  EXPECT_EQ(1, l.GetHead()->GetDat());
  EXPECT_EQ(2, l.GetHead()->GetNextNode()->GetDat());
  EXPECT_EQ(NULL, l.GetHead()->GetNextNode()->GetNextNode());
}
...
{
  Node* p = l.Search(3);
  Node* ptrue = l.GetHead()->GetNextNode()->GetNextNode();
  EXPECT_EQ(ptrue, p);
}
...
{
  l.Inverse();
  EXPECT_EQ(3, l.GetHead()->GetDat());
  EXPECT_EQ(2, l.GetHead()->GetNextNode()->GetDat());
  EXPECT_EQ(1, l.GetHead()->GetNextNode()->GetNextNode()->GetDat());
  EXPECT_EQ(NULL, l.GetHead()->GetNextNode()->GetNextNode()->GetNextNode());
}
...
TEST_F(ThreeNodesList, can_assign_two_not_empty_lists_of_eq_size)
{
  ...
  l2.InserToTail(33);
  l = l2;
  EXPECT_EQ(11, l.GetHead()->GetDat());
  EXPECT_EQ(22, l.GetHead()->GetNextNode()->GetDat());
  EXPECT_EQ(33, l.GetHead()->GetNextNode()->GetNextNode()->GetDat());
  EXPECT_EQ(NULL, l.GetHead()->GetNextNode()->GetNextNode()->GetNextNode());
}
...
{
    ASSERT_NO_THROW(l.Merge(l.GetHead()->GetNextNode(), l2));
}

TEST_F(TwoListsTest, merge_after_ptr_two_not_empty_lists_is_correct)
{
    List l3 = l.Merge(l.GetHead()->GetNextNode(), l2);
    List res;
    res.InserToTail(1);
    res.InserToTail(2);  
    res.InserToTail(11);
...
{
    List l3 = l.Merge(l.GetHead()->GetNextNode(), z);
    EXPECT_EQ(l, l3);
}
